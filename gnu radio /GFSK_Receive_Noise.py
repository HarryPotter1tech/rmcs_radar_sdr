...
class GFSK_Receive_Noise(gr.top_block, Qt.QWidget):
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "GFSK_Receive_Noise")
        ...
        self.signal_configs = signal_configs = {
            "red": {"signal_frequency": 433200000},
            "blue": {"signal_frequency": 433920000},
        }
        ...
        self.signal_frequency = signal_frequency = signal_configs[enemyside][
            "signal_frequency"
        ]
        self.signal_bandwidth = signal_bandwidth = 540000
        self.sample_rate = sample_rate = 1000000
        self.pi = pi = 3.141592653589793
        self.noise_sensitivity = noise_sensitivity = noise_configs[noise_grade_chooser][
            enemyside
        ]["noise_sensitivity"]
        self.noise_frequency = noise_frequency = noise_configs[noise_grade_chooser][
            enemyside
        ]["noise_frequency"]
        self.noise_bandwidth = noise_bandwidth = noise_configs[noise_grade_chooser][
            enemyside
        ]["noise_bandwidth"]
        self.SPS = SPS = 52
        ...
        self.qtgui_time_sink_x_0_0_0_0_0_0_0_2_0.set_trigger_mode(
        ...
        markers = [4, -1, -1, -1, -1, -1, -1, -1, -1, -1]

        for i in range(2):
            if len(labels[i]) == 0:
                if i % 2 == 0:
                    self.qtgui_time_sink_x_0_0_0_0_0_0_0_2_0.set_line_label(
        ...
        self._qtgui_time_sink_x_0_0_0_0_0_0_0_2_0_win = sip.wrapinstance(
            self.qtgui_time_sink_x_0_0_0_0_0_0_0_2_0.qwidget(), Qt.QWidget
        )
        ...
        self.qtgui_time_sink_x_0_0_0_0_0_0_0_1_0.set_trigger_mode(
            qtgui.TRIG_MODE_FREE, qtgui.TRIG_SLOPE_POS, 0.0, 0, 0, ""
        )
        ...
        for i in range(1):
            if len(labels[i]) == 0:
                self.qtgui_time_sink_x_0_0_0_0_0_0_0_1_0.set_line_label(
                    i, "Data {0}".format(i)
                )
            else:
        ...
        self._qtgui_time_sink_x_0_0_0_0_0_0_0_1_0_win = sip.wrapinstance(
            self.qtgui_time_sink_x_0_0_0_0_0_0_0_1_0.qwidget(), Qt.QWidget
        )
        ...
        self._qtgui_freq_sink_x_0_0_1_win = sip.wrapinstance(
            self.qtgui_freq_sink_x_0_0_1.qwidget(), Qt.QWidget
        )
        ...
        self._noise_grade_chooser_callback = lambda i: Qt.QMetaObject.invokeMethod(
            self._noise_grade_chooser_button_group,
            "updateButtonChecked",
            Qt.Q_ARG("int", self._noise_grade_chooser_options.index(i)),
        )
        ...
        self.network_tcp_sink_0_0 = network.tcp_sink(
            gr.sizeof_char, 1, "127.0.0.1", 2500, 2
        )
        self.low_pass_filter_0_0 = filter.fir_filter_ccf(
            1, firdes.low_pass(1, sample_rate, 500000, 10000, window.WIN_HAMMING, 6.76)
        )
        self.iio_pluto_source_1 = iio.fmcomms2_source_fc32(
            "192.168.3.10" if "192.168.3.10" else iio.get_pluto_uri(),
            [True, True],
            32768,
        )
        ...
        self._enemyside_callback = lambda i: Qt.QMetaObject.invokeMethod(
            self._enemyside_button_group,
            "updateButtonChecked",
            Qt.Q_ARG("int", self._enemyside_options.index(i)),
        )
        ...
        self.digital_correlate_access_code_xx_ts_0_0 = (
            digital.correlate_access_code_bb_ts(
                "0001011011101000110100110111011100010101000111000111000100101101",
                12,
                "access_code+header",
            )
        )
        self.blocks_stream_to_tagged_stream_0_0 = blocks.stream_to_tagged_stream(
            gr.sizeof_char, 1, 15, "packet_len"
        )
        self.blocks_file_sink_0_0_0 = blocks.file_sink(
            gr.sizeof_char * 1,
            "/home/pinkpanda/linux-RADAR/RADAR-2026/RADAR-SDR/receive.bin",
            False,
        )
        ...
        self.connect(
            ...
            (self.qtgui_time_sink_x_0_0_0_0_0_0_0_1_0, 0),
        )
        self.connect(
        ...
        self.connect(
            (self.blocks_stream_to_tagged_stream_0_0, 0), (self.network_tcp_sink_0_0, 0)
        )
        self.connect(
        ...
        self.connect(
            (self.digital_gfsk_demod_0_0, 0), (self.blocks_char_to_float_0_0_0, 0)
        )
        self.connect(
        ...
        self.connect(
            (self.low_pass_filter_0_0, 0), (self.qtgui_time_sink_x_0_0_0_0_0_0_0_2_0, 0)
        )
    ...
    def set_signal_configs(self, signal_configs):
        self.signal_configs = signal_configs
        self.set_signal_frequency(
            self.signal_configs[self.enemyside]["signal_frequency"]
        )
    ...
    def set_noise_grade_chooser(self, noise_grade_chooser):
        ...
        self.set_noise_bandwidth(
            self.noise_configs[self.noise_grade_chooser][self.enemyside][
                "noise_bandwidth"
            ]
        )
        self.set_noise_frequency(
            self.noise_configs[self.noise_grade_chooser][self.enemyside][
                "noise_frequency"
            ]
        )
        self._noise_grade_chooser_callback(self.noise_grade_chooser)
        self.set_noise_sensitivity(
            self.noise_configs[self.noise_grade_chooser][self.enemyside][
                "noise_sensitivity"
            ]
        )
    ...
    def set_sample_rate(self, sample_rate):
        ...
        self.low_pass_filter_0_0.set_taps(
            firdes.low_pass(
                1, self.sample_rate, 500000, 10000, window.WIN_HAMMING, 6.76
            )
        )
        self.qtgui_freq_sink_x_0_0_1.set_frequency_range(
            self.noise_frequency, self.sample_rate * 2
        )
        self.qtgui_time_sink_x_0_0_0_0_0_0_0_1_0.set_samp_rate(
            self.sample_rate / self.SPS
        )
...
def main(top_block_cls=GFSK_Receive_Noise, options=None):
